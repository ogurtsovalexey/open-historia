...
function worldInput(): WorldStateV2Input {
  ...
  return {
    ...
    institutions: [],
    concepts: [{
      conceptId: 'concept:writing', type: 'technology', semanticKey: 'writing',
      displayName: { en: 'Writing' }, description: { en: 'Recorded symbolic communication' },
      origin: { kind: 'scenario', originEntityRefs: ['polity:alpha'], originMonth: '1900-01-01' },
      parentConceptIds: [], supportingEvidenceIds: ['evidence:concept-writing'], domains: ['domain:communication'],
      status: 'institutionalized', maturityBp: 10000, diffusion: [],
      adoption: [{ scope: 'polity', polityId: 'polity:alpha', adoptionBp: 10000 }],
      provenance: {
        kind: 'scenario', sourceEvidenceId: 'evidence:concept-writing',
        createdRevision: seedRevision, createdMonth: '1900-01-01',
      },
