...
const TASK_DEFINITIONS = [
  ...
  {
    taskId: 'opponents.plan-statecraft',
    version: 1,
    kind: 'structured',
    authority: 'proposal',
    contextPolicyId: 'opponent-public-strategy-batch',
    budgetPolicyId: 'large-generation',
    outputContractId: 'opponent-public-strategy-batch-schema',
    allowedVariants: [],
    fallbackPolicy: 'surface-error',
    mayMutateState: true
  },
  {
    taskId: 'opponents.plan-politics',
    version: 1,
    kind: 'structured',
    authority: 'proposal',
    contextPolicyId: 'opponent-public-politics-batch',
    budgetPolicyId: 'large-generation',
    outputContractId: 'opponent-public-strategy-batch-schema',
    allowedVariants: [],
    fallbackPolicy: 'surface-error',
  ...
  {
    taskId: 'opponents.plan-war',
    version: 1,
    kind: 'structured',
    authority: 'proposal',
    contextPolicyId: 'opponent-public-war-batch',
    budgetPolicyId: 'large-generation',
    outputContractId: 'opponent-public-strategy-batch-schema',
    allowedVariants: [],
    fallbackPolicy: 'surface-error',
  ...
  {
    taskId: 'opponents.plan-society',
    version: 1,
    kind: 'structured',
    authority: 'proposal',
    contextPolicyId: 'opponent-public-society-batch',
    budgetPolicyId: 'large-generation',
    outputContractId: 'opponent-public-strategy-batch-schema',
    allowedVariants: [],
    fallbackPolicy: 'surface-error',
  ...
  },
  {
    ...
    kind: 'structured',
    authority: 'proposal',
    contextPolicyId: 'opponent-public-campaign-batch',
    budgetPolicyId: 'large-generation',
    outputContractId: 'opponent-public-strategy-batch-schema',
    allowedVariants: [],
    fallbackPolicy: 'surface-error',
  ...
  {
    taskId: 'reports.explain-campaign',
    version: 1,
    kind: 'structured',
    authority: 'explanation',
    contextPolicyId: 'player-campaign-report',
    budgetPolicyId: 'medium-generation',
    outputContractId: 'player-economy-report-schema',
    allowedVariants: [],
    fallbackPolicy: 'deterministic',
...
const STRATEGIC_TASKS = new Set([
  ...
  'opponents.plan-statecraft',
  'opponents.plan-politics',
  'opponents.plan-war',
  'opponents.plan-society',
  'opponents.plan-campaign',
  'chat.diplomacy.plan',
